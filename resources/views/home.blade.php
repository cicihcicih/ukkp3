...
<head>
	...
	<!-- Bootstrap core CSS -->
	<link href="{{ asset('ini/vendor/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">
	<!-- Fontawesome CSS -->
	<link href="{{ asset('ini/css/all.css')}}" rel="stylesheet">
	<!-- Owl Carousel CSS -->
	<link href="{{ asset('ini/css/owl.carousel.min.css')}}" rel="stylesheet">
	<!-- Owl Carousel CSS -->
	<link href="{{ asset('ini/css/jquery.fancybox.min.css')}}" rel="stylesheet">
	<!-- Custom styles for this template -->
	<link href="{{ asset('ini/css/style.css')}}" rel="stylesheet">
</head>
<body>
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="contact-details">
						<ul>
							<li><i class="fas fa-phone fa-rotate-90"></i> +16 89644012540</li>
							<li><i class="fas fa-map-marker-alt"></i> jln kedungwaringin, Bekasi</li>
						</ul>
					</div>
				</div>
			</div>
...
<script src="{{ asset('ini/vendor/jquery/jquery.min.js')}}"></script>
<script src="{{ asset('ini/vendor/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
<script src="{{ asset('ini/js/imagesloaded.pkgd.min.js')}}"></script>
<script src="{{ asset('ini/js/isotope.pkgd.min.js')}}"></script>
<script src="{{ asset('ini/js/filter.js')}}"></script>
<script src="{{ asset('ini/js/jquery.appear.js')}}"></script>
<script src="{{ asset('ini/js/owl.carousel.min.js')}}"></script>
<script src="{{ asset('ini/js/jquery.fancybox.min.js')}}"></script>
<script src="{{ asset('ini/js/script.js')}}"></script>
</body>
</html>